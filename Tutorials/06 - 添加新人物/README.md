...
public class MyCharacter extends CustomPlayer {
    // 火堆的人物立绘（行动前）
    private static final String MY_CHARACTER_SHOULDER_1 = ModHelper.MakePath("img/char/shoulder1.png");
    // 火堆的人物立绘（行动后）
    private static final String MY_CHARACTER_SHOULDER_2 = ModHelper.MakePath("img/char/shoulder2.png");
    // 人物死亡图像
    private static final String CORPSE_IMAGE = ModHelper.MakePath("img/char/corpse.png");
    // 战斗界面左下角能量图标的每个图层
    private static final String[] ORB_TEXTURES = new String[]{
            ModHelper.MakePath("img/UI/orb/layer5.png"),
            ModHelper.MakePath("img/UI/orb/layer4.png"),
            ModHelper.MakePath("img/UI/orb/layer3.png"),
            ModHelper.MakePath("img/UI/orb/layer2.png"),
            ModHelper.MakePath("img/UI/orb/layer1.png"),
            ModHelper.MakePath("img/UI/orb/layer6.png"),
            ModHelper.MakePath("img/UI/orb/layer5d.png"),
            ModHelper.MakePath("img/UI/orb/layer4d.png"),
            ModHelper.MakePath("img/UI/orb/layer3d.png"),
            ModHelper.MakePath("img/UI/orb/layer2d.png"),
            ModHelper.MakePath("img/UI/orb/layer1d.png")
    };
    // 每个图层的旋转速度，没必要修改
    ...
    public MyCharacter(String name) {
        super(name, CEOBE, ORB_TEXTURES, ModHelper.MakePath("img/UI/orb/vfx.png"), LAYER_SPEED, null, null);
        ...
        this.initializeClass(
            ModHelper.MakePath("img/char/character.png"), // 人物图片
    ...
    public List<CutscenePanel> getCutscenePanels() {
        ...
        panels.add(new CutscenePanel(ModHelper.MakePath("img/char/Victory1.png", "ATTACK_MAGIC_FAST_1")));
        panels.add(new CutscenePanel(ModHelper.MakePath("img/char/Victory2.png")));
        panels.add(new CutscenePanel(ModHelper.MakePath("img/char/Victory3.png")));
        return panels;
    }
